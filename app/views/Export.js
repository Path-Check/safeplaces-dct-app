      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.main}>
          <Text style={styles.mainText}>
            You can share you location trail with anyone using the Share button
            below. Once you press the button it will ask you with whom and how
            you want to share it.
          </Text>
          <Text style={styles.mainText}>
            Location is shared as a simple list of times and coordinates, no
          ...
          <Text style={styles.mainText}>
            Points to be shared: {LocationServices.getPointCount()}
          </Text>
        </View>
      </SafeAreaView>
    );

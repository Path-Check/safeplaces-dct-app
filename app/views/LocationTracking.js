...
class LocationTracking extends Component {
  ...
  getiOSVersionLessThan12()
  {
    if(Platform.OS==='ios'&& Platform.Version <= 12.1)
    {
      return true
    }
    return  false
  ...
  getSettings() {
    return (
      <TouchableOpacity
        ...
        {this.getiOSVersionLessThan12()?( <Image
            style={{
              width: 32,
              height: 32,
              resizeMode: 'contain',

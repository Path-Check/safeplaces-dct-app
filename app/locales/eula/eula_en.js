...
**Definitions**. As used in these Terms of Use, the following definitions apply:
...
“**Safe Places Software**” means open-source software, available at [https://github.com/tripleblindmarket/safe-places](https://github.com/tripleblindmarket/safe-places), that facilitates contact tracing and related tasks, and is designed for use by third parties, such as government agencies.
...
THE AVAILABILITY OF THE APPLICATION AND ITS FEATURES MAY BE SUBJECT TO DELAYS, CANCELLATIONS AND OTHER DISRUPTIONS. PCI MAKES NO WARRANTY, REPRESENTATION OR CONDITION WITH RESPECT TO THE APPLICATION OR ITS FEATURES, INCLUDING BUT NOT LIMITED TO, THE QUALITY, EFFECTIVENESS, REPUTATION AND OTHER CHARACTERISTICS THEREOF.

        4.

NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED FROM PCI OR THROUGH THE APPLICATION WILL CREATE ANY WARRANTY NOT EXPRESSLY MADE HEREIN.
...
**Cap on Liability.** TO THE MAXIMUM EXTENT PERMITTED BY LAW, NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY DAMAGES ARISING FROM OR RELATED TO THESE TERMS OF USE (FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION), WILL AT ALL TIMES BE LIMITED TO A MAXIMUM OF FIFTY US DOLLARS (U.S. \$50). THE EXISTENCE OF MORE THAN ONE CLAIM WILL NOT ENLARGE THIS LIMIT. YOU AGREE THAT OUR SUPPLIERS WILL HAVE NO LIABILITY OF ANY KIND ARISING FROM OR RELATING TO THESE TERMS OF USE.

    3.

**Your Data.** EXCEPT FOR PCI’S OBLIGATIONS TO PROTECT YOUR PERSONAL DATA AS SET FORTH IN THE PCI’S PRIVACY POLICY, PCI ASSUMES NO RESPONSIBILITY FOR THE TIMELINESS, DELETION, MIS-DELIVERY OR FAILURE TO STORE ANY CONTENT (INCLUDING YOUR LOCATION HISTORY), USER COMMUNICATIONS OR PERSONALIZATION SETTINGS.

    4.

**Basis of the Bargain.** THE LIMITATIONS OF DAMAGES SET FORTH ABOVE ARE FUNDAMENTAL ELEMENTS OF THE BASIS OF THE BARGAIN BETWEEN PCI AND YOU.
...
**Term.** This Agreement commences on the date when you accept them (as described in the preamble above) and remain in full force and effect while you use the Application, unless terminated earlier in accordance with this Agreement.
...
**Termination by You. **If you want to terminate this Agreement, you may do so by deleting the Application from your mobile device.

    9.

**Effect of Termination.** Termination of this Agreement requires you to delete the Application and cease all use of it. All provisions of this Agreement which by their nature should survive, shall survive termination, including without limitation, ownership provisions, warranty disclaimers, and limitation of liability.

3.
**INTERNATIONAL USERS. **The Application is intended solely for use in the United States of America. PCI makes no representations that the Application is functional in other locations. Those who access or use the Application from other countries do so at their own risk and are responsible for use in compliance with local law.

4.
**DISPUTE RESOLUTION*. Please read the following arbitration agreement in this Section (“\_Arbitration Agreement*”) carefully.  It requires U.S. users to arbitrate disputes with PCI and limits the manner in which you can seek relief from us. \_**

    10.

**Applicability of Arbitration Agreement*.*** You agree that any dispute, claim, or request for relief relating in any way to your access or use of the Application or to any aspect of your relationship with PCI, will be resolved by binding arbitration, rather than in court, except that (1) you may assert claims or seek relief in small claims court if your claims qualify,; and (2) you or PCI may seek equitable relief in court for infringement or other misuse of intellectual property rights (such as trademarks, trade dress, domain names, trade secrets, copyrights, and patents). **This Arbitration Agreement shall apply, without limitation, to all disputes or claims and requests for relief that arose or were asserted before the effective date of this Agreement or any prior version of this Agreement. **
...
**30-Day Right to Opt Out**. You have the right to opt out of the provisions of this Arbitration Agreement by sending written notice of your decision to opt out to: legal@pathcheck.org, within 30 days after first becoming subject to this Arbitration Agreement. Your notice must include your name and address, your email address, and an unequivocal statement that you want to opt out of this Arbitration Agreement. If you opt out of this Arbitration Agreement, all other parts of this Agreement will continue to apply to you. Opting out of this Arbitration Agreement has no effect on any other arbitration agreements that you may currently have, or may enter in the future, with us.

    16.

**Severability*. ***Except as provided in subsection 13.5, if any part or parts of this Arbitration Agreement are found under the law to be invalid or unenforceable, then such specific part or parts shall be of no force and effect and shall be severed and the remainder of the Arbitration Agreement shall continue in full force and effect.

    17.

**Survival of Agreement*. ***This Arbitration Agreement will survive the termination of your relationship with PCI.
...
**Electronic Communications.** The communications between you and PCI may take place via electronic means, whether you send PCI e-mails, or whether PCI posts notices in the Application or through updates made to the Application in accordance with this Terms of Use or communicates with you via e-mail. For contractual purposes, you (a) consent to receive communications from PCI in an electronic form; and (b) agree that all terms and conditions, agreements, notices, disclosures, and other communications that PCI provides to you electronically satisfy any legal requirement that such communications would satisfy if it were to be in writing. The foregoing does not affect your statutory rights, including but not limited to the Electronic Signatures in Global and National Commerce Act at 15 U.S.C. §7001 et seq. (“E-Sign”).

    20.

**Release.** You hereby release the PCI Parties and their successors from claims, demands, any and all losses, damages, rights, and actions of any kind, including personal injuries, death, and property damage, that is either directly or indirectly related to or arises from any interactions with or conduct of operators of Third Party Safe Places Web Apps, healthcare providers, governmental agencies, of any kind arising in connection with or as a result of this Agreement or your use of the Application. If you are a California resident, you hereby waive California Civil Code Section 1542, which states, “A general release does not extend to claims that the creditor or releasing party does not know or suspect to exist in his or her favor at the time of executing the release and that, if known by him or her, would have materially affected his or her settlement with the debtor or released party.” The foregoing release does not apply to any claims, demands, or any losses, damages, rights and actions of any kind, including personal injuries, death or property damage for any unconscionable commercial practice by a PCI Party or for such party’s fraud, deception, false, promise, misrepresentation or concealment, suppression or omission of any material fact in connection with the Application provided hereunder.

    21.

**Assignment.** This Agreement, and your rights and obligations hereunder, may not be assigned, subcontracted, delegated or otherwise transferred by you without PCI’s prior written consent, and any attempted assignment, subcontract, delegation, or transfer in violation of the foregoing will be null and void.

    22.

**Force Majeure.** PCI shall not be liable for any delay or failure to perform resulting from causes outside its reasonable control, including, but not limited to, acts of God, war, terrorism, riots, embargos, acts of civil or military authorities, fire, floods, accidents, strikes or shortages of transportation facilities, fuel, energy, labor or materials.

    23.

**Questions, Complaints, Claims.** If you have any questions, complaints or claims with respect to the Application, please contact us at: support@pathcheck.org.

    24.

**Exclusive Venue.** To the extent the parties are permitted under this Agreement to initiate litigation in a court, both you and PCI agree that all claims and disputes arising out of or relating to this Agreement will be litigated exclusively in the state or federal courts located in Boston, Massachusetts.
...
**Notice.** You may give notice to PCI at the following address: Path Check, Inc. PO Box 441621, Somerville MA 02144. Such notice shall be deemed given when received by PCI by letter delivered by nationally recognized overnight delivery service or first class postage prepaid mail at the above address.
...
You acknowledge and agree that (i) this Agreement is concluded between you and PCI only, and not Apple, and (ii) PCI, not Apple, is solely responsible for the App Store Sourced Application and content thereof. Your use of the App Store Sourced Application must comply with the App Store Terms of Service.
...
In the event of any failure of the App Store Sourced Application to conform to any applicable warranty, you may notify Apple, and Apple will refund the purchase price for the App Store Sourced Application to you and to the maximum extent permitted by applicable law, Apple will have no other warranty obligation whatsoever with respect to the App Store Sourced Application. As between PCI and Apple, any other claims, losses, liabilities, damages, costs or expenses attributable to any failure to conform to any warranty will be the sole responsibility of PCI.

        4.

You and PCI acknowledge that, as between PCI and Apple, Apple is not responsible for addressing any claims you have or any claims of any third party relating to the App Store Sourced Application or your possession and use of the App Store Sourced Application, including, but not limited to: (i) product liability claims; (ii) any claim that the App Store Sourced Application fails to conform to any applicable legal or regulatory requirement; and (iii) claims arising under consumer protection or similar legislation.

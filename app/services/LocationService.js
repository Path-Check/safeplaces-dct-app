...
import { geoHashArray, sha256Array } from '../helpers/Intersect';
...
function saveLocation(location) {
  ...
  GetStoreData('LOCATION_DATA').then(locationArrayString => {
    ...
    /*
    //WARNING: Only uncomment for testing purposes, it can block the threads
    //for long time if there are lot of coordinates
    const geoHashedArray = geoHashArray(curated);
    sha256Array(geoHashedArray).then(hashedArray => {

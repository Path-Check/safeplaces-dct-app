      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.main}>
          <Text style={styles.label}>
            {languages.t('label.FORMGENERAL_NAME')}
          </Text>
          <TextInput
          ...
          />
          <Text style={styles.label}>
            {languages.t('label.FORMGENERAL_DATEBIRTH')}
          </Text>
          <TouchableOpacity
          ...
          <Text style={styles.label}>
            {languages.t('label.FORMGENERAL_IDENTIFICATION')}
          </Text>
          <TextInput
          ...
          />
          <Text style={styles.label}>
            {languages.t('label.FORMGENERAL_ADDRESS')}
          </Text>
          <TextInput
          ...
          />
          <Text style={styles.label}>
            {languages.t('label.FORMGENERAL_REASON')}
          </Text>
          <Picker
            ...
            style={styles.picker}>
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_SELECT')}
            />
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_1')}
              value={1}
            />
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_2')}
              value={2}
            />
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_3')}
              value={3}
            />
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_4')}
              value={4}
            />
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_5')}
              value={5}
            />
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_6')}
              value={6}
            />
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_7')}
              value={7}
            />
            <Picker.Item
              label={languages.t('label.FORMGENERAL_REASON_8')}
              value={8}
            />
          </Picker>
          <Text style={{ padding: 10 }}>
            {this.state.reason &&
              languages.t('label.FORMGENERAL_REASON_' + this.state.reason)}
          </Text>
          {this.state.reason == 8 && (
            <TextInput
